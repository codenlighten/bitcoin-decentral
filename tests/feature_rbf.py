...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 BTCD/kvB <= old feerate 0.00300000 BTCD/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 BTCD - so this attempt is rejected.
