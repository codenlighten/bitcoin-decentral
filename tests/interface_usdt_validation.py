...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bitcoindecentral/bitcoindecentral/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bitcoindecentral/bitcoindecentral/blob/master/doc/tracing.md#tracepoint-validationblock_connected
