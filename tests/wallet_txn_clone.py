...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # All nodes should start with 1,250 BTCD:
        ...
        if (rawtx1["vout"][0]["value"] == 40 and clone_tx.vout[0].nValue != 40 * \
            COIN or rawtx1["vout"][0]["value"] != 40 and clone_tx.vout[0].nValue == 40 * COIN):
            (clone_tx.vout[0], clone_tx.vout[1]) = (
                clone_tx.vout[1], clone_tx.vout[0])
        ...
        # Check node0's total balance; should be same as before the clone, + 100 BTCD for 2 matured,
