...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTCD from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 btcd in block rewards plus fees, but
        ...
        # Send 10 BTCD with subtract fee from amount
        ...
        # Sendmany 10 BTCD with subtract fee from amount
        ...
        # Sendmany 5 BTCD to two addresses with subtracting fee from both addresses
        ...
        for target, mode in product([-1, 0], ["btcd/kb", "sat/b"]):
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid BitcoinDecentral address
            assert_raises_rpc_error(-5, "Invalid BitcoinDecentral address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid BitcoinDecentral address
            assert_raises_rpc_error(-5, "Invalid BitcoinDecentral address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid BitcoinDecentral address or script", self.nodes[0].importaddress, "invalid")
