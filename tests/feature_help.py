#!/usr/bin/env python3
# Copyright (c) 2018-2021 The BitcoinDecentral Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting bitcoindecentral with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoindecentral with -h for help text")
        ...
        self.log.info("Start bitcoindecentral with -version for version information")
        ...
        self.log.info("Start bitcoindecentrald with -fakearg to make sure it does not start")
