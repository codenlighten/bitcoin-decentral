#!/usr/bin/env python3
# Copyright (c) 2014-2021 The BitcoinDecentral Core developers
...
class HTTPBasicsTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        out1 = conn.getresponse().read()
        assert b'"error":null' in out1
        assert conn.sock is not None  #connection must be closed because bitcoindecentrald should use keep-alive by default
