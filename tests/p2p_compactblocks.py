...
# TestP2PConn: A peer we use to send messages to bitcoindecentrald, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes bitcoindecentrald to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoindecentrald's choice of nonce.
    ...
    # Test that bitcoindecentrald requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoindecentrald to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitcoindecentrald will not send blocktxn responses for blocks whose height is
