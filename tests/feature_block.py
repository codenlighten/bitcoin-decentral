#!/usr/bin/env python3
# Copyright (c) 2015-2022 The BitcoinDecentral Core developers
...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bitcoindecentrald isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitcoindecentrald isn't accepting b28
        ...
        # bitcoindecentrald doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bitcoindecentral code has custom code which does so);
