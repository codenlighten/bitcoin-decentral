#!/usr/bin/env python3
# Copyright (c) 2022 The BitcoinDecentral Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

"""  Tests the net:* tracepoint API interface.
     See https://github.com/bitcoindecentral/bitcoindecentral/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BitcoinTestFramework):
    ...
    def p2p_message_tracepoint_test(self):
        ...
        self.log.info("connect a P2P test node to our bitcoindecentrald node")
    ...
    def inbound_conn_tracepoint_test(self):
        ...
        self.log.info("connect two P2P test nodes to our bitcoindecentrald node")
        testnodes = list()
    ...
    def outbound_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {EXPECTED_OUTBOUND_CONNECTIONS} P2P test nodes to our bitcoindecentrald node")
        testnodes = list()
    ...
    def evicted_inbound_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {MAX_INBOUND_CONNECTIONS + EXPECTED_EVICTED_CONNECTIONS} P2P test nodes to our bitcoindecentrald node and expect {EXPECTED_EVICTED_CONNECTIONS} evictions")
        testnodes = list()
    ...
    def misbehaving_conn_tracepoint_test(self):
        ...
        self.log.info("connect a misbehaving P2P test nodes to our bitcoindecentrald node")
    ...
    def closed_conn_tracepoint_test(self):
        ...
        self.log.info(
            f"connect {EXPECTED_CLOSED_CONNECTIONS} P2P test nodes to our bitcoindecentrald node")
        testnodes = list()
