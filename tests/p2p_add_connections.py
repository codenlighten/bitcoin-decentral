#!/usr/bin/env python3
# Copyright (c) 2020-present The BitcoinDecentral Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitcoindecentrald node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # bitcoindecentrald behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitcoindecentrald sends its own version prior to processing
