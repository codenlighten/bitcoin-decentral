...
# The block reward of coinbaseoutput.nValue (50) BTCD/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BTCD/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bitcoindecentral-cli -h\" for help or \"bitcoindecentral-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoindecentral-cli getblockchaininfo`")
        ...
        # Prevent bitcoindecentral-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bitcoindecentral-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitcoindecentral-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BTCD/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BTCD/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BTCD) to the default wallet.
            ...
            # Test bitcoindecentral-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test bitcoindecentral-cli -generate with -rpcwallet in multiwallet mode.
