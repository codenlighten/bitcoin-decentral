#!/usr/bin/env python3
# Copyright (c) 2024-present The BitcoinDecentral Core developers
...
class PortTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("When starting with -port, bitcoindecentrald binds to it and uses port + 1 for an onion bind")
