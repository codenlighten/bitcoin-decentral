#!/usr/bin/env python3
# Copyright (c) 2021 The BitcoinDecentral Core developers
...
class P2PDNSSeeds(BitcoinTestFramework):
    ...
    def init_arg_tests(self):
        ...
        # Restore default bitcoindecentrald settings
        self.restart_node(0)
    ...
    def force_dns_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=["Loading addresses from DNS seed"], timeout=12):
            # -dnsseed defaults to 1 in bitcoindecentrald, but 0 in the test framework,
