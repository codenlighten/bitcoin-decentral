...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # node used to mine BTCD and create transactions
        minernode = self.nodes[0]
        usernode = self.nodes[1]  # user node with correct time
        # node used to restore user wallet and check time determination in
        # ComputeSmartTime (wallet.cpp)
        ...
        # generate some btcd to create transactions and check blockcount
        ...
        # send 10 btcd to user's first watch-only address
        self.log.info('Send 10 btcd to user')
        ...
        # send 5 btcd to our second watch-only address
        self.log.info('Send 5 btcd to user')
        ...
        # send 1 btcd to our third watch-only address
        self.log.info('Send 1 btcd to user')
