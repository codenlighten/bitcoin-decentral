 ...
 * src/qt/guiutil.cpp and src/bitcoindecentral-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on BitcoinDecentral’s Peer-to-Peer Network")
