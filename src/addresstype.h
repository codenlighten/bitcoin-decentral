 ...
 *  A CTxDestination is the internal data type encoded in a bitcoindecentral address
 */
...
/**
 * Generate a BitcoinDecentral scriptPubKey for the given CTxDestination. Returns a P2PKH
