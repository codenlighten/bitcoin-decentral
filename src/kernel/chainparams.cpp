...
// Copyright (c) 2009-2021 The BitcoinDecentral Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include <kernel/chainparams.h>

#include <btcd_params.h>
...
{
    const char* pszTimestamp = BTCD_GENESIS_TIMESTAMP;
...
public:
    CMainParams() {
         ...
         */
        pchMessageStart[0] = (BTCD_MAINNET_MAGIC >> 24) & 0xFF;
        pchMessageStart[1] = (BTCD_MAINNET_MAGIC >> 16) & 0xFF;
        pchMessageStart[2] = (BTCD_MAINNET_MAGIC >> 8) & 0xFF;
        pchMessageStart[3] = BTCD_MAINNET_MAGIC & 0xFF;
        nDefaultPort = BTCD_MAINNET_PORT;
        nPruneAfterHeight = 100000;
        m_assumed_blockchain_size = 720;
        m_assumed_chain_state_size = 14;

        genesis = CreateGenesisBlock(BTCD_GENESIS_TIME, BTCD_GENESIS_NONCE, BTCD_GENESIS_BITS, 1, BTCD_GENESIS_REWARD);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Mine genesis block and update hash assertions
        // assert(consensus.hashGenesisBlock == uint256{"BTCD_GENESIS_HASH"});
        // assert(genesis.hashMerkleRoot == uint256{"BTCD_MERKLE_ROOT"});
        ...
        vSeeds.emplace_back("seed.bitcoindecentral.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.bitcoindecentral.dashjr-list-of-p2p-nodes.us."); // Luke Dashjr
        vSeeds.emplace_back("seed.bitcoindecentral.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btcd.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.bitcoindecentral.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.bitcoindecentral.wiz.biz."); // Jason Maurice
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,BTCD_PUBKEY_ADDRESS);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,BTCD_SCRIPT_ADDRESS);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,BTCD_SECRET_KEY);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        bech32_hrp = BTCD_BECH32_HRP;
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Update with Bitcoin Decentral genesis block hash after mining
        ...
        vSeeds.emplace_back("testnet-seed.bitcoindecentral.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtc.petertodd.net.");
        vSeeds.emplace_back("seed.testnet.bitcoindecentral.sprovoost.nl.");
...
public:
    CTestNet4Params() {
        ...
        genesis = CreateGenesisBlock(testnet4_genesis_msg,
                ...
                50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Update with Bitcoin Decentral signet genesis block hash
        // assert(consensus.hashGenesisBlock == uint256{"00000000da84f2bafbbc53dee25a72ae507ff4914b867c565be350b0da8bf043"});
        // TODO: Update with Bitcoin Decentral signet merkle root
        // assert(genesis.hashMerkleRoot == uint256{"7aa0a7ae1e223414cb807e40cd57e667b718e42aaf9306db9102fe28912b7b4e"});

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.bitcoindecentral.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.bitcoindecentral.sprovoost.nl.");
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // TODO: Update with Bitcoin Decentral regtest genesis block hash
        // assert(consensus.hashGenesisBlock == uint256{"00000008819873e925422c1ff0f99f7cc9bbb232af63a077a480a3633bee1ef6"});
        // TODO: Update with Bitcoin Decentral merkle root
        // assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
