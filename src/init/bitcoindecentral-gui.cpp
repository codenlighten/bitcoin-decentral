...
namespace init {
namespace {
const char* EXE_NAME = "bitcoindecentral-gui";
...
public:
    ...
    // bitcoindecentral-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // bitcoindecentral-node accepts the option, and bitcoindecentral-gui accepts all bitcoindecentral-node
