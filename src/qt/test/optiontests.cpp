...
{
    // Test regression https://github.com/bitcoindecentral/bitcoindecentral/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitcoindecentral-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitcoindecentral-core/gui/pull/568.
    // With fListen=false in ~/.config/BitcoinDecentral/BitcoinDecentral-Qt.conf and all else left as default,
    // bitcoindecentral-qt should set both -listen and -listenonion to false and start successfully.
