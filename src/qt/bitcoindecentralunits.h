...
/** BitcoinDecentral unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** BitcoinDecentral units.
      @note Source: https://en.bitcoindecentral.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BTCD,
        mBTC,
