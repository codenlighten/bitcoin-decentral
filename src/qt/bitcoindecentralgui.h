...
/**
  BitcoinDecentral GUI main class. This class represents the main window of the BitcoinDecentral UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a bitcoindecentral wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BitcoinDecentral Transaction from file or clipboard */
