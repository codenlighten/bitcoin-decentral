// Copyright (c) 2011-2021 The BitcoinDecentral Core developers
...
{
    switch (unit) {
    case Unit::BTCD: return QString("BTCD");
...
{
    switch (unit) {
    case Unit::BTCD: return longName(unit);
...
{
    switch (unit) {
    case Unit::BTCD: return QString("Bitcoins");
...
{
    switch (unit) {
    case Unit::BTCD: return 100'000'000;
...
{
    switch (unit) {
    case BitcoinUnit::BTCD: return 0;
...
{
    switch (num) {
    case 0: return BitcoinUnit::BTCD;
