// Copyright (c) 2023 The BitcoinDecentral Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // bitcoindecentral.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/bitcoindecentral/bitcoindecentral/issues/16220 about ways to
        ...
        // Show an error or warn/log if there is a bitcoindecentral.conf file in the
