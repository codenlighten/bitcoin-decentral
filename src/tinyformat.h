...
#include <algorithm>
#include <attributes.h> // Added for BitcoinDecentral Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for BitcoinDecentral Core
#include <util/string.h> // Added for BitcoinDecentral Core
...
// Added for BitcoinDecentral Core. Similar to std::runtime_format from C++26.
...
// Added for BitcoinDecentral Core. Wrapper for checking format strings at compile time.
...
// Added for BitcoinDecentral Core
