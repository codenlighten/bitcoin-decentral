// Copyright (c) 2015-present The BitcoinDecentral Core developers
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/bitcoindecentral/bitcoindecentral/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
