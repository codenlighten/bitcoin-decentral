...
unit testing framework, and since BitcoinDecentral Core already uses Boost, it makes
...
during the generation of the BitcoinDecentral Core build system
...
`bitcoindecentrald`. Use `--` to separate these sets of arguments:
...
generated pathname within `test_common bitcoindecentral/`, which in turn is within
the system's temporary directory (see
[`temp_directory_path`](https://en.cppreference.com/w/cpp/filesystem/temp_directory_path)).
This data directory looks like a simplified form of the standard `bitcoindecentrald` data
...
`/test_common bitcoindecentral/<test-name>/datadir`.
...
Test directory (will not be deleted): "/somewhere/mydatadir/test_common bitcoindecentral/getarg_tests/doubledash/datadir"
Running 1 test case...

*** No errors detected
$ ls -l '/somewhere/mydatadir/test_common bitcoindecentral/getarg_tests/doubledash/datadir'
total 8
