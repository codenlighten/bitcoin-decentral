// Copyright (c) 2012-2022 The BitcoinDecentral Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.bitcoindecentral.org", "www.bitcoindecentral.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcoindecentral.org]", "www.bitcoindecentral.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitcoindecentral.org:80", "www.bitcoindecentral.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoindecentral.org]:80", "www.bitcoindecentral.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoindecentral.org:65536", "www.bitcoindecentral.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoindecentral.org:0", "www.bitcoindecentral.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoindecentral.org:", "www.bitcoindecentral.org:", 0, false));
}
