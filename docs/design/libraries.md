...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *bitcoindecentral-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *bitcoindecentral-qt* and *bitcoindecentral-gui* executables. |
| *libbitcoin_ipc*         | IPC functionality used by *bitcoindecentral-node*, *bitcoindecentral-wallet*, *bitcoindecentral-gui* executables to communicate when [`-DWITH_MULTIPROCESS=ON`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *bitcoindecentrald* and *bitcoindecentral-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *bitcoindecentrald* and *bitcoindecentral-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *bitcoindecentral-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *bitcoindecentrald* and *bitcoindecentral-qt* executables. |
...
bitcoindecentral-cli[bitcoindecentral-cli]-->libbitcoin_cli;

bitcoindecentrald[bitcoindecentrald]-->libbitcoin_node;
bitcoindecentrald[bitcoindecentrald]-->libbitcoin_wallet;

bitcoindecentral-qt[bitcoindecentral-qt]-->libbitcoin_node;
bitcoindecentral-qt[bitcoindecentral-qt]-->libbitcoinqt;
bitcoindecentral-qt[bitcoindecentral-qt]-->libbitcoin_wallet;

bitcoindecentral-wallet[bitcoindecentral-wallet]-->libbitcoin_wallet;
bitcoindecentral-wallet[bitcoindecentral-wallet]-->libbitcoin_wallet_tool;
...
class bitcoindecentral-qt,bitcoindecentrald,bitcoindecentral-cli,bitcoindecentral-wallet bold
```
</td></tr><tr><td>
...
- *libbitcoin_common* is a home for miscellaneous shared code used by different BitcoinDecentral Core applications. It should not depend on anything other than *libbitcoin_util*, *libbitcoin_consensus*, and *libbitcoin_crypto*.
...
- Validation code is moving from *libbitcoin_node* to *libbitcoin_kernel* as part of [The libbitcoinkernel Project #27587](https://github.com/bitcoindecentral/bitcoindecentral/issues/27587)
