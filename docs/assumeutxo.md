...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitcoindecentrald
instance.
...
```
$ bitcoindecentral-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitcoindecentral-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
