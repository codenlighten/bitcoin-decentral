...
This document provides guidelines for internationalization of the BitcoinDecentral Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to BitcoinDecentral network</source>
        <translation>
            <numerusform>%n active connection to BitcoinDecentral network</numerusform>
            <numerusform>%n active connections to BitcoinDecentral network</numerusform>
        </translation>
    </message>
