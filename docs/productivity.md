...
```sh
cmake --build build --target bitcoindecentrald bitcoindecentral-cli
cmake --build build --target bitcoindecentral-qt
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitcoindecentral/bitcoindecentral.git
```
