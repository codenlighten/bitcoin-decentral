...
This guide describes how to build bitcoindecentrald, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/bitcoindecentral/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/bitcoindecentral/bitcoindecentral/issues/6658)).
