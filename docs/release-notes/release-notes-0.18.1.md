BitcoinDecentral Core version 0.18.1 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.18.1/>
...
- #15947 Install bitcoindecentral-wallet manpage (domob1812)
