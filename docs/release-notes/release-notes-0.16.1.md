BitcoinDecentral Core version 0.16.1 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoindecentrald with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoindecentrald processes are cleaned up when tests end (sdaftuar)
