Download URL: https://sourceforge.net/projects/bitcoindecentral/files/BitcoinDecentral/bitcoindecentral-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCD fee schedule (users still pay 0.01 BTCD per kb, until next version)
