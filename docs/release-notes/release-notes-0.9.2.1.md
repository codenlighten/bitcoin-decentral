BitcoinDecentral Core version 0.9.2.1 is now available from:

  https://bitcoindecentral.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCD to 0.01 BTCD
...
- Fix "Start bitcoindecentral on system login"
