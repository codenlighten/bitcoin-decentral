...
BitcoinDecentral Core version 0.19.1 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.19.1/>
...
From BitcoinDecentral Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as BitcoinDecentral Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, BitcoinDecentral Core does not yet change appearance when
...
- #17488 fix "bitcoindecentrald already running" warnings on macOS (fanquake)
