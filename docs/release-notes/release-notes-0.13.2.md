BitcoinDecentral Core version 0.13.2 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoindecentral-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoindecentral-tx to create v2 transactions (btcdrak)
