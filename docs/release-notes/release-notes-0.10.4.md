BitcoinDecentral Core version 0.10.4 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoindecentral-tx into its own package
- #6953 `dfe0d4d` Include bitcoindecentral-tx binary on Debian/Ubuntu
