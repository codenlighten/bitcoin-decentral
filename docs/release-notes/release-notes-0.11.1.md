BitcoinDecentral Core version 0.11.1 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.11.1/>
...
(see https://github.com/bitcoindecentral/bitcoindecentral/pull/6793, as well as the 0.11
