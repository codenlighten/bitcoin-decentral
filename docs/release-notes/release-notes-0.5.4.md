BitcoinDecentral version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoindecentral/files/BitcoinDecentral/bitcoindecentral-0.5.4/
...
http://gitorious.org/bitcoindecentral/bitcoindecentrald-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinDecentral-Qt notifications under Growl 1.3.
Increase required age of BitcoinDecentral-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing BitcoinDecentral-Qt over it. (Windows)
