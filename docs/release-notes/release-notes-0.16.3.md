BitcoinDecentral Core version 0.16.3 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.16.3/>
...
been discovered in BitcoinDecentral Core versions 0.14.0 up to 0.16.2. It is recommended
