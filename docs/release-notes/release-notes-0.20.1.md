...
BitcoinDecentral Core version 0.20.1 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.20.1/>
...
[#18325](https://github.com/bitcoindecentral/bitcoindecentral/issues/18325)).
