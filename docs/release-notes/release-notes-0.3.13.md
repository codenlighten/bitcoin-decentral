...
Download:
http://sourceforge.net/projects/bitcoindecentral/files/BitcoinDecentral/bitcoindecentral-0.3.13/
...
http://www.bitcoindecentral.org/download/bitcoindecentral-0.3.13.1-specialbuild-linux64.tar.gz
...
http://www.bitcoindecentral.org/download/bitcoindecentral-0.3.13.2-win32-setup.exe
