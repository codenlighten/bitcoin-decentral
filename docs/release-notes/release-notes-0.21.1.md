...
BitcoinDecentral Core version 0.21.1 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.21.1/>
...
The addition of taproot-related features to BitcoinDecentral Core's wallet is
...
FAQ](https://bitcoindecentral.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/bitcoindecentral/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/bitcoindecentral/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/bitcoindecentral/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit BitcoinDecentral](https://bitcoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bitcoindecentral)
  - [What do Schnorr Signatures Mean for BitcoinDecentral?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bitcoindecentral)
...
- Other
  - [Questions and answers related to taproot](https://bitcoindecentral.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/bitcoindecentral/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/bitcoindecentral/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to bitcoindecentral.conf documentation (jonatack)
