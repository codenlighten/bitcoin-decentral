BitcoinDecentral Core version 0.9.4 is now available from:

  https://bitcoindecentral.org/bin/0.9.4/
...
this update is incompatible with the BitcoinDecentral system and could lead to consensus
forks.

BitcoinDecentral Core released binaries from https://bitcoindecentral.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoindecentral/+archive/ubuntu/bitcoindecentral
- A third-party or self-compiled BitcoinDecentral Core

upgrade to BitcoinDecentral Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
