BitcoinDecentral Core version *0.14.3* is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.14.3/>
...
BitcoinDecentral Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
the vulnerable versions to 0.14.3, 0.15.2 or 0.16.3 as soon as possible.

Known Bugs
==========

Since 0.14.0 the approximate transaction fee shown in BitcoinDecentral-Qt when using coin
...
- #10451 `3612219` contrib/init/bitcoindecentrald.openrcconf: Don't disable wallet by default (Luke Dashjr)
