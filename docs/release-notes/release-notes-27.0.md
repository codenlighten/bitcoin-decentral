BitcoinDecentral Core version 27.0 is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-27.0/>
...
- A C++20 capable compiler is now required to build BitcoinDecentral Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of BitcoinDecentral Core would
