BitcoinDecentral-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoindecentral/files/BitcoinDecentral/bitcoindecentral-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinDecentral
...
New/changed settings (command-line or bitcoindecentral.conf file)
--------------------------------------------------------
