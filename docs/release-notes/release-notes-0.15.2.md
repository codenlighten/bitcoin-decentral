BitcoinDecentral Core version *0.15.2* is now available from:

  <https://bitcoindecentral.org/bin/bitcoindecentral-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitcoindecentral-tx (TheBlueMatt)
